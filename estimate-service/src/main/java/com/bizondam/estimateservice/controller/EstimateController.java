...
public class EstimateController {
  ...
  public ResponseEntity<Long> createEstimate(@RequestBody EstimateRequestCreateDto dto) {
    Long requestId = estimateService.createEstimate(dto);
  ...
  public ResponseEntity<Long> createResponse(@RequestBody EstimateResponseCreateDto dto) {
